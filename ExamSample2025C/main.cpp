...
int main() {
    ...
    Dog d3("Rex","Nemetjuhasz",2);
    // Hozzaadas
    cout<<"Kutyak hozzaadasa a menhelyhez...\n";
    shelter+d1;
    shelter+d2;
    shelter+d3;
    std::cout<<shelter<<"\n";
    // Duplikalthozzaadas-kiveteltkelldobjon
    std::cout<<"Duplikalt kutya hozzaadasa...\n";
    try
    {
        shelter+d2;
        }
